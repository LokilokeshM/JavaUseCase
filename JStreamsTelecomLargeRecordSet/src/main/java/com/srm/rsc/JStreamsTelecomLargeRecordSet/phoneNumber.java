...
public class phoneNumber extends phoneType{
	...
	public phoneNumber(String vas, boolean isActive, String description, String phoneNumber, String avlCredits,
			String is4g, Integer billAmount) {
